      ...
      <div className='mb-6 border-b border-gray-200 pb-6'>
        ...
        <div className='flex flex-col gap-y-6 md:flex-row md:items-end md:gap-x-4'>
          ...
          <Button
            ...
            className='mt-2 w-full shrink-0 md:mt-0 md:w-auto'
          >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              template "<strong>{templateNameToDelete}</strong>".
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setTemplateNameToDelete(null)}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
